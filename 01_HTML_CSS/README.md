# Tema 01 – Desenvolupament web amb HTML5 i CSS3
...
| **07. Propietats CSS, Box Model i Estils Moderns**  | 4     | Color, Text, Fons, Dimensions, Vores, Transformacions, Transicions, Animacions, etc. |
| **08. Pseudoclasses i Pseudoelements**              | 1     | Aplicar estils a elements amb un valor o estat concret (hover, focus, active, etc.)  |
| **09. Disposició d'elements**                       | 1     | Display, posicionament relatiu, absolut i estàtic.                                   |
| **10. Disseny flexible**                            | 1     | Disseny de layouts flexibles amb flexbox.                                            |
