...
| ----------------- | ------------------------------------------------------------------------------ |
| `box-shadow`      | Afegeix ombres a les caixes. Donen profunditat i sensació de flotació.         |
| `border-radius`   | Arrodoneix les cantonades d’una caixa (targetes, botons, etc.).                |
| `opacity`         | Controla la transparència de l’element (`1` és opac, `0` és invisible).        |
| `filter`          | Aplica filtres visuals com blur, grisos, saturació, etc.                       |
| `backdrop-filter` | Aplica filtres als elements del fons (efectes de *glassmorphism*).             |
