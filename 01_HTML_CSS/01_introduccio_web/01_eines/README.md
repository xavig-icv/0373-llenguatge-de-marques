...
- **Inspeccionar element** (`F12` o clic dret > _Inspeccionar_): Obre les eines de desenvolupador del navegador, que ens permeten visualitzar i modificar l'HTML i el CSS renderitzat en temps real.
