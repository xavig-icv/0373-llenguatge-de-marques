...
| **HTMLHint**                  | HTMLHint         | Ressalta errors i advetències del codi HTML.       | ✅ Recomanat |
| **HTML CSS Support**          | ecmel            | Intellisense per CSS dins de fitxers HTML.         | ✅ Recomanat |
| **indent-rainbow**            | oderwat          | Mostra colors d'indentació de manera visual.       | ✅ Recomanat |
...
| **JSON Crack**                     | Aykut Saraç    | Mostra fitxers JSON en un format visual.       | ⚠️ Opcional  |
...
## Treball amb XML i XSD

| Extensió         | Desenvolupador | Funció principal               | Estatus      |
| ---------------- | -------------- | ------------------------------ | ------------ |
| **XML**          | Red Hat        | Suport de llenguatge XML.      | ✅ Oficial   |
| **XML Tools**    | Josh Johnson   | Formatació i validació XML.    | ✅ Recomanat |
| **Xml Complete** | rogalmic       | Autocompletat per XML amb XSD. | ✅ Recomanat |

## Altres

| Extensió              | Desenvolupador | Funció principal                              | Estatus     |
| --------------------- | -------------- | --------------------------------------------- | ----------- |
| **Project Templates** | cantonios      | Crear plantilles de projecte personalitzades. | ⚠️ Opcional |
